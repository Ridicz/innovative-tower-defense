...
public class UI {
  ...
  private void initializeButtons() {
    ...
    towerButtonList.add(new TowerButton(240, MAP_HEIGHT + 10, 80, 110, Action.TOWER, new FastLaserTower(0, 0, waveManager), waveManager, quickLoadTexture("laser_tower_button")));
